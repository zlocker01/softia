 ...
 *
 * @description This component uses the `dark` class on the root element to switch between
 * light and dark mode. It also uses SVG icons from Bootstrap to display a moon
 * or sun icon to indicate the current mode.
 *
